...
<div class="card" style="display:flex;flex-direction:column;justify-content:center;gap:1.25rem;padding:.75rem">
  <div>
    <div style="display:flex;justify-content:space-between;margin:.4rem;font-size:.9rem">
