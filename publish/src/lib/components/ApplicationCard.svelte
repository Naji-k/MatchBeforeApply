...
>
  <div style="display:flex;align-items:center;gap:.75rem">
    ...
    {:else}
      <div
        style="width:56px;height:56px;border-radius:50%;background:var(--color-surface-2);flex-shrink:0;display:flex;align-items:center;justify-content:center"
      >
    ...
    <div style="flex:1;min-width:0">
      <p
        style="font-weight:600;font-size:.9rem;color:var(--color-text-primary);overflow:hidden;text-overflow:ellipsis;"
      >
        {title}
      </p>
      <p
        style="font-size:.8rem;color:var(--color-text-muted);margin-top:.15rem;overflow:hidden;text-overflow:ellipsis"
      >
        {company}
      </p>
    </div>
